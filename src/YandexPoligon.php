...
class YandexPoligon
{
    ...
    {
        $api = new GetYandexDistanceToMKAD();
        $result = array();
        $sort = array();
    ...
    public static function GetMkadPolygon()
    {
        ...
        {
            $points[] = new YandexPoint(null, $km[1], $km[2]);
        }

        $polygon = new YandexPoligon($points);
